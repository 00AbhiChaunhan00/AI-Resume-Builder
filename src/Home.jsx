  ...
  const features = [
    {
      ...
      desc: "Use our creation tools and expert AI guidance to create the perfect resume for your next job application.",
    },
    {
      icon: <MdPerson className="text-5xl text-purple-500" />,
      title: "Professional template",
      desc: "Have a applicant tracking systems (ATS)-friendly modern and professional template.",
    },
    {
      icon: <FaPalette className="text-5xl text-purple-500" />,
      title: "Customize colors and themes",
      desc: "Select custom themes and colors on resume template.",
    },
    {
      icon: <FaFileAlt className="text-5xl text-purple-500" />,
      title: "Free resume examples",
      desc: "Use our resume example and template to see what a great resume looks like in your field.",
    },
    {
      icon: <AiOutlineFileText className="text-5xl text-purple-500" />,
      title: "ATS-friendly templates",
      desc: "Sail through applicant tracking systems with resume template that appeal to both machines and humans.",
    },
    {
      icon: <FaSearch className="text-5xl text-purple-500" />,
      title: "Expert AI tips and guidance",
      desc: "Get help every step of the way as you build your resume with expert AI tips and suggested phrases.",
    },
  ];
  return (
    <div
      style={{ backgroundColor: "#CBC7C7" }}
        ...
        <section className="z-50">
          <div className="py-8 px-4 mx-auto  max-w-screen-xl text-center lg:py-16 lg:px-12">
            <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl">
              Build Your Resume{" "}
              <span style={{ color: "#9450FF" }} className="text-primary">
                With AI
              </span>
            </h1>
            ...
            <div className=" mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
              ...
              <div className="mt-10 w-full max-w-3xl mx-auto">
                <div
                  style={{ backgroundColor: "#CBC7C7" }}
                  className="flex flex-wrap sm:flex-nowrap justify-center bg-white "
                >
                  <div
                    className="p-5 sm:p-6 md:p-8 border-r-2 border-dashed border-pink-300 flex flex-col justify-center 
 w-full sm:w-1/3 min-w-[160px] max-w-full"
                  >
                    <div className="flex items-center text-4xl sm:text-5xl font-extrabold leading-none text-fuchsia-700">
                      <ArrowUp
                        className="w-8 h-8 sm:w-10 sm:h-10 mr-1 text-fuchsia-700"
                        strokeWidth={3}
                      />
                  ...
                  <div
                    className="p-5 sm:p-6 md:p-8 flex flex-col justify-center w-full sm:w-1/3
          ...
          <div className="relative w-full overflow-hidden">
            <div className="flex gap-20 animate-scroll whitespace-nowrap">
              {logos.map((item, index) => (
                <div
                  key={index}
                  className="text-black opacity-80 hover:opacity-100 transition"
                >
                  {item.icon}
                </div>
              ))}
