...
const ViewResume = () => {
  ...
  // for getting the perfect area of the page to download the resume with add css by their id as you can in div 
  return (
    <>
      <div id="no-print">
        <Header />
        <div className="my-10 mx-10 md:mx-20 lg:max-30">
          ...
          <p className="text-center ">
            You are ready to download your resume and can share with resume url{" "}
          </p>
          <div className="flex justify-center px-10 my-10">
            <Button
              style={{ backgroundColor: "#9450FF", width: "150px" }}
              onClick={HandleInput}
            >
              Download <ArrowDown />
            </Button>
