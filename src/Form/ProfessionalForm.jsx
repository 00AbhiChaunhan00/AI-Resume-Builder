...
function ProfessionalForm() {
  ...
  const [experienceList, setExperienceList] = useState([{ ...formField }]); // we make this {... } beacuse for every list we get the new data otherwise at first stage it give the same
  ...
  useEffect(() => {
    setResumeInfo({
      // here we set our new data and it will be displayed on preview resume
      ...ResumeInfo,
      experience: experienceList,
    });
  }, [experienceList]);
